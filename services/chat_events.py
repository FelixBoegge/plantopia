...
#
# Each names what was consulted and what for. "the local weather" said what the answer
# was about but not where it came from, which is the half somebody weighing an answer
# actually wants. Where the source is this application's own data it says so, rather
# than implying a third party that does not exist.
TOOL_NAMES = {
